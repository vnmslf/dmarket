...
$APPLICATION->SetPageProperty("keywords", "доставка, виды доставки, способы доставки");
$APPLICATION->SetPageProperty("title", "Доставка | «Дельта-Маркет»");
...
<p>
	 Срок хранения в постамате 3 дня, но можно продлить ещё на аналогичный срок. <br>
</p>
