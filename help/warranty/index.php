...
$APPLICATION->SetPageProperty("title", "Гарантия | «Дельта-Маркет»");
$APPLICATION->SetPageProperty("keywords", "гарантия на станки, гарантия на оборудование");
$APPLICATION->SetPageProperty("description", "Гарантийные обязательства «Дельта-Маркет»");
