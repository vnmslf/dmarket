...
$APPLICATION->SetPageProperty("HIDETITLE", "N");
$APPLICATION->SetPageProperty("title", "Акции и скидки");
$APPLICATION->SetPageProperty("description", "Будьте первыми в курсе новостей и акций, получайте промокоды на бесплатную доставку и дополнительные скидки!");
$APPLICATION->SetTitle("Акционные предложения");
?>
